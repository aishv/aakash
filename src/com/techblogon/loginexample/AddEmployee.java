...
public class AddEmployee extends Activity {
	...
	public void btnAddEmp_Click(View view)
	{
		...
		finally
		{
			if(ok)
			{
				...
				txtEmps.setText("Number of new college registered "+String.valueOf(dbHelper.getEmployeeCount()));
			}
		}
	}
	...
	void NotifyEmpAdded()
	{
		...
		diag.setTitle("Add new College");
		TextView txt=new TextView(this);
		txt.setText("College Added Successfully");
		diag.setContentView(txt);
		diag.show();
		try {
			diag.wait(1000);
